...
bool YOLO11::init(string path, rknn_core_mask core_mask) {
...
void YOLO11::preprocess(Mat& data) {
...
void YOLO11::postprocess(vector<vector<float>>& result, float conf_thresh, float iou_thresh) {
...
bool YOLO11::inputImage(Mat& image) {
...
vector<vector<float>> YOLO11::getResult(float conf_thresh, float iou_thresh) {
